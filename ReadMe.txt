...
6-Admin mode in which you can acces all the functionality of the client (add product to cart, cashout, and user page) the admin has on the menu the option to add product and delete(still to be implemented) them from the web interface.
